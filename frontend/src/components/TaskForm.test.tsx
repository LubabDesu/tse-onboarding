...
describe("taskForm", () => {
  ...
  it("calls submit handler with edited fields", async () => {
    ...
    expect(updateTask).toHaveBeenCalledWith({
      _id: mockTask._id, // Use mockTask field
      title: "Updated title", // The value we just typed
      description: "Updated description", // The value we just typed
      assignee: "", // Instruction: "use the empty string"
      isChecked: mockTask.isChecked, // Use mockTask field
      dateCreated: mockTask.dateCreated, // Use mockTask field
    });
    await waitFor(() => {
